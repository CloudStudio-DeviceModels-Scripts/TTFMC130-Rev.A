...
# Parsing + Configuration Script – TTFMC130 - Rev. A

This **Parsing + Configuration** script is designed for the **TTFMC130** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – TTFMC130 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **TTFMC130** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
